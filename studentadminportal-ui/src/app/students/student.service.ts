...
export class StudentService {
  ...
  updateStudent(studentId: string, studentRequest: Student): Observable<Student>{
    ...
    return this.httpClient.put<Student>(this.baseApiUri + '/students/' + studentId, updateStudentRequest);
  }
  ...
  addStudent(studentRequest: Student): Observable<Student> {
    ...
    return this.httpClient.post<Student>(this.baseApiUri + '/students/add', addStudentRequest);
  }
}
